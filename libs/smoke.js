	  ...
	  i: 0,
		...
		build: function (e, f) {
					...
					box = 
						...
						'<div class="dialog smoke animated fadeInDown'+classname+'">'+
		...
		finishbuildAlert: function (e, f, box) {
			smoke.listen(
				...
				"click", 
				function () {
					$('.smoke').removeClass('fadeInDown');
					$('.smoke').addClass('fadeOutUp');

					setTimeout(function(){ //allow for animation
						// smoke.destroy(f.type, f.newid);
